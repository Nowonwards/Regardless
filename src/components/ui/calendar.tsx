    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-lg transition-colors hover:bg-primary/10 hover:text-primary'
        ),
        ...
        day_today: 'bg-accent/50 text-accent-foreground font-semibold border border-primary/30',
        day_outside:
