...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-none p-1 border border-border opacity-70 transition-opacity hover:opacity-100 hover:bg-surface focus:outline-none focus:ring-1 focus:ring-ring disabled:pointer-events-none data-[state=open]:bg-surface data-[state=open]:text-muted-foreground">
        <X className="h-4 w-4" />
