        ...
        <section className="lg:col-span-6 space-y-6 lg:pr-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Create your account to start generating tech social carousels, brainstorm breaking news hooks with live Tavily search, and automate your publishing queue.
            </p>
          </div>
